...
#Actual Code for the coding challenge.
...
story = f"Hello {name}! Your ability to {power} will make sure you never have to look at {enemy} again. Go eat {food} as you walked down the streets of {location} and use {power} for good and not evil!"
